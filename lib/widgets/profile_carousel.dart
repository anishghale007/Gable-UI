                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${jobList[0]}', style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${jobList[1]}', style: TextStyle(
                                  fontSize: 15, color: Colors.grey),),
                            ],
                          ),
                        ],
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${jobList[2]}', style: TextStyle(
                                  fontSize: 15, color: Colors.grey),),
                            ],
                          ),
                        ],
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${jobList[3]}', style: TextStyle(
                                  fontSize: 15, color: Colors.grey),),
                            ],
                          ),
                        ],
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${jobList[4]}', style: TextStyle(
                                  fontSize: 15, color: Colors.grey),),
                            ],
                          ),
                        ],
                        ...
                        children: [
                          RichText(
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    text: 'View Profile ->', style: TextStyle(color: mainTextColor),
                                  ),
                                  ...
                                  WidgetSpan(
                                      child: Container(
                                        ...
                                        child: Icon(Icons.favorite, color: mainTextColor, size: 18,),
                                      ),),
                                ],
                              ),),
                        ],
